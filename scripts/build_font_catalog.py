...
The download step is intentionally separate: assets are sourced from the
upstream Google Fonts repository, while this script only validates paths,
licenses, and stable identifiers in a checkout.
"""
