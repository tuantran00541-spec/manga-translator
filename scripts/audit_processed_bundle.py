...
Manual repaint masks are treated as human correction evidence. They provide a
repeatable completion proxy (how often automatic cleanup needed intervention),
while review/residue state comes from the persisted manifest. This report does
not claim detector recall unless a separately labelled source dataset exists.
"""
