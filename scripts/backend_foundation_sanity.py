...
def publication_safety_checks():
    ...
    p="\n".join((ROOT/name).read_text(encoding='utf-8') for name in ('app/pipeline.py','app/page_processing.py','app/pipeline_editing.py')); rr=(ROOT/'app/routers/render_commit.py').read_text(encoding='utf-8'); ex=(ROOT/'app/routers/export.py').read_text(encoding='utf-8')
