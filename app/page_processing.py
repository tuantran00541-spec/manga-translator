...
class PageProcessingMixin:
    ...
    def _review_only_residue_sources(records: list[dict] | None) -> list[BubbleBox]:
        """ These boxes are intentionally NOT erase authority. They only make the post-inpaint verifier inspect story-like text evidence that policy held back from automatic cleanup (for example a full-width free-text bbox). """
