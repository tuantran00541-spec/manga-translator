...
def is_story_candidate(box: dict | None) -> bool:
    """ High-confidence detector evidence likely to carry story text. OCR eligibility and planner state are deliberately ignored. Curation cannot make detector evidence disappear merely by changing scheduling fields. """
