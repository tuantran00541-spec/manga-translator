...
EDITORIAL_STORY_CANDIDATE_CONFIDENCE = _env_float(
    "MANGA_EDITORIAL_STORY_CANDIDATE_CONFIDENCE", 0.70, minimum=0.0, maximum=1.0
)
...
DETECTOR_GRAYSCALE_FALLBACK_HARD_MAX_ROIS = _env_int(
    "MANGA_DETECTOR_GRAYSCALE_FALLBACK_HARD_MAX_ROIS", 6, minimum=1, maximum=24
)
DETECTOR_GRAYSCALE_FALLBACK_PROPOSALS_PER_EXTRA_ROI = _env_int(
    "MANGA_DETECTOR_GRAYSCALE_FALLBACK_PROPOSALS_PER_EXTRA_ROI", 3, minimum=1, maximum=50
)
...
DETECTOR_FOCUS_HARD_MAX_CHIPS = _env_int(
    "MANGA_DETECTOR_FOCUS_HARD_MAX_CHIPS", 6, minimum=1, maximum=12
)
DETECTOR_FOCUS_PROPOSALS_PER_EXTRA_CHIP = _env_int(
    "MANGA_DETECTOR_FOCUS_PROPOSALS_PER_EXTRA_CHIP", 3, minimum=1, maximum=50
)
...
DETECTOR_TEXT_MASK_CONTINUATION_ENABLED = _env_bool(
    "MANGA_DETECTOR_TEXT_MASK_CONTINUATION_ENABLED", True
)
DETECTOR_TEXT_MASK_CONTINUATION_STEP = _env_int(
    "MANGA_DETECTOR_TEXT_MASK_CONTINUATION_STEP", 32, minimum=4, maximum=128
)
DETECTOR_TEXT_MASK_CONTINUATION_MAX_EXTRA = _env_int(
    "MANGA_DETECTOR_TEXT_MASK_CONTINUATION_MAX_EXTRA", 192, minimum=0, maximum=512
)
DETECTOR_TEXT_MASK_CONTINUATION_EDGE_MARGIN = _env_int(
    "MANGA_DETECTOR_TEXT_MASK_CONTINUATION_EDGE_MARGIN", 12, minimum=1, maximum=64
)
DETECTOR_TEXT_MASK_CONTINUATION_MIN_NEW_PIXELS = _env_int(
    "MANGA_DETECTOR_TEXT_MASK_CONTINUATION_MIN_NEW_PIXELS", 8, minimum=1, maximum=4096
)
...
DETECTOR_RESIDUE_VERIFY_ENABLED = _env_bool(
    "MANGA_DETECTOR_RESIDUE_VERIFY_ENABLED", True
)
DETECTOR_RESIDUE_VERIFY_MAX_ROIS = _env_int(
    "MANGA_DETECTOR_RESIDUE_VERIFY_MAX_ROIS", 8, minimum=1, maximum=24
)
DETECTOR_RESIDUE_VERIFY_PAD = _env_int(
    "MANGA_DETECTOR_RESIDUE_VERIFY_PAD", 12, minimum=0, maximum=128
)
DETECTOR_RESIDUE_VERIFY_MAX_SOURCE_SIDE = _env_int(
    "MANGA_DETECTOR_RESIDUE_VERIFY_MAX_SOURCE_SIDE", 1344, minimum=256, maximum=4096
)
...
INPAINT_NATIVE_TILE_EDGE_DENSITY_MIN = _env_float(
    "MANGA_INPAINT_NATIVE_TILE_EDGE_DENSITY_MIN", 0.055, minimum=0.0, maximum=1.0
)
INPAINT_NATIVE_TILE_MASK_AREA_MIN = _env_int(
    "MANGA_INPAINT_NATIVE_TILE_MASK_AREA_MIN", 256, minimum=1, maximum=10_000_000
)
...
RENDER_MIN_READABLE_FONT_SIZE = _env_int(
    "MANGA_RENDER_MIN_READABLE_FONT_SIZE", 12, minimum=6, maximum=512
)
RENDER_SAFE_CAPTION_EXPANSION = _env_bool(
    "MANGA_RENDER_SAFE_CAPTION_EXPANSION", True
)
RENDER_SAFE_CAPTION_EXPANSION_RATIO = _env_float(
    "MANGA_RENDER_SAFE_CAPTION_EXPANSION_RATIO", 0.20, minimum=0.0, maximum=1.0
)
...
DOWNLOAD_RETRY_ATTEMPTS = _env_int(
    "MANGA_DOWNLOAD_RETRY_ATTEMPTS", 4, minimum=1, maximum=10
)
DOWNLOAD_RETRY_BACKOFF_SECONDS = _env_float(
    "MANGA_DOWNLOAD_RETRY_BACKOFF_SECONDS", 1.0, minimum=0.0, maximum=30.0
)
...
RENDER_MIN_READABLE_FONT_SIZE = min(RENDER_MIN_READABLE_FONT_SIZE, MAX_FONT_SIZE)
