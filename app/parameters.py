...
DETECTOR_RETRY_SEGMENTER_ENABLED = _env_bool(
    "MANGA_DETECTOR_RETRY_SEGMENTER_ENABLED", True
)
...
DETECTOR_TEXT_FULLPAGE_PASS_ENABLED = _env_bool(
    "MANGA_DETECTOR_TEXT_FULLPAGE_PASS_ENABLED", True
)
...
DETECTOR_FOCUS_ROI_FIRST_ENABLED = _env_bool(
    "MANGA_DETECTOR_FOCUS_ROI_FIRST_ENABLED", False
)
